...
function encryptDecryptCalixto(initialMessage, displacement, encryptDecrypt){
...
function encrypt() {
    ...
    else if(currentMethod == CAL_METHOD){
        finalMessage = encryptDecryptCal(initialMessage, CAL_DISPLACEMENT, "encrypt");
    }
...
function decrypt() {
    ...
    if(currentMethod == ALURA_METHOD){
        ...
        finalMessage = encryptDecryptCal(finalMessage, CAL_DISPLACEMENT, "decrypt");
    }
...
function changeEncryptMethod(){
    ...
    let calPrimaryColor = getComputedStyle(document.documentElement).getPropertyValue('--dark-red-300-color');
    let calSecondaryColor = getComputedStyle(document.documentElement).getPropertyValue('--light-red-color');
    let calBackgroundColor = getComputedStyle(document.documentElement).getPropertyValue('--light-red-100-color');
    ...
    if(currentMethod == ALURA_METHOD){
        ...
        root.style.setProperty('--current-method-primary-color', calPrimaryColor);
        root.style.setProperty('--current-method-secondary-color', calSecondaryColor);
        root.style.setProperty('--current-method-background-color', calBackgroundColor);
    }
    else {
...
const CAL_DISPLACEMENT = 666;
const ALURA_METHOD = "alura";
const CAL_METHOD = "calixto";
